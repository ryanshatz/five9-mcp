...
const GROUPS = [
  { name: 'Connection & context', icon: '🔌', tools: ['about', 'check_connection'] },
  { name: 'Campaigns', icon: '📞', tools: ['list_campaigns', 'inspect_campaign', 'control_campaign', 'manage_campaign_lists'] },
  ...
  { name: 'CRM contacts', icon: '👤', tools: ['search_contacts', 'update_contact', 'list_contact_fields'] },
  { name: 'Compliance', icon: '🚫', tools: ['manage_dnc'] },
  { name: 'Domain configuration', icon: '🏢', tools: ['list_users', 'list_skills', 'list_dispositions', 'list_agent_groups', 'list_ivr_scripts', 'list_dnis'] },
